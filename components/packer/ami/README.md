#  AMI with Packer & Atmos

ဤ Directory သည် Atmos နှင့် Packer ကို အသုံးပြုပြီး ပရောဂျက်အတွက် လိုအပ်သော Amazon Machine Image (AMI) ဖန်တီးရန် တည်ဆောက်ထားခြင်းဖြစ်ပါသည်။
...
atmos packer init ami -s packer
```
...
atmos packer build ami -s packer
```

ဤသို့ Run လိုက်ပါက အလုပ်လုပ်ဆောင်မှု ပြီးဆုံးသည့်အခါ သင်၏ AWS account အတွင်းသို့ `-base-image-<timestamp>` အမည်ဖြင့် အသင့်သုံးနိုင်သော AMI အသစ်တစ်ခု ရောက်ရှိလာမည်ဖြစ်ပါသည်။
...
```bash
atmos packer validate ami -s packer
```
...
data "aws_ami" "_ami" {
  ...
  filter {
    name   = "tag:Name"
    values = ["base-image"] # AMI ပေါ်ရှိ Tag Name နှင့် ကိုက်ညီရမည်
  }
...
AMI အသစ်ထွက်လာတိုင်း ထို AMI ID နှင့် Version ကို AWS SSM Parameter Store သို့ အလိုအလျောက် လှမ်းရေး (Write) ခိုင်းထားနိုင်ပါသည်။ (ဥပမာ - `//develop/latest_ami_id` သို့ `ami-0a1b2c...` ကို သိမ်းခြင်း)။ နောက်ပိုင်းတွင် ထို Parameter Store ထဲဝင်ကြည့်ရုံဖြင့် မှတ်တမ်းများကို သေသေချာချာ စီမံနိုင်ပါသည်။
...
၁။ **Base Image ထုတ်ခြင်း**: Packer ဖြင့် `packer.yaml` ကို အသုံးချကာ `-base-image` ဆိုသည့် သီးသန့် Unified AMI တစ်ခုတည်းကိုသာ (Environment မခွဲဘဲ) ပုံသေ တည်ဆောက်ပါ။
၂။ **Develop တွင် စမ်းသပ်ခြင်း**: Terraform က ထို `-base-v1.0.0` AMI အသစ်ကို ယူပြီး Dev Environment တွင် အရင် Deployment လုပ်ပါသည်။
၃။ **Ansible ဖြင့် ပုံသွင်းခြင်း**: ထို AMI ပေါ်သို့ Ansible က `dev` အတွက် Nginx Config လာရောက် ပုံသွင်းပါသည်။
၄။ **Prod သို့ Promote လုပ်ခြင်း**: Dev တွင် စမ်းသပ်ပြီး အဆင်ပြေသွားပါက ဧပြီလတွင် Prod Deploy လုပ်သည့်အခါ၊ Prod Terraform က **AMI အသစ်ထပ်မဆောက်ဘဲ** မတ်လက စမ်းသပ်အောင်မြင်ခဲ့သည့် `base-v1.0.0` (AMI ID အဟောင်း) ကိုပင် ပြန်လည်အသုံးပြုပါသည်။
၅။ **Prod ကို ပုံသွင်းခြင်း**: ထို့နောက် Ansible က Prod အတွက် သီးသန့် Nginx Config ကို အဆိုပါ AMI ပေါ်သို့ လာရောက် ပုံသွင်းပေးပါသည်။ အကယ်၍ သက်ဆိုင်ရာ Environment-specific package များ (dev အတွက် သီးသန့် tools များ) လိုအပ်ပါက၊ ၎င်းဖြစ်စဉ်များကို Packer Base Image ထဲတွင် မထည့်ဘဲ နောက်ဆုံးအဆင့်တွင် Ansible ဖြင့်သာ လာရောက်သွင်းသင့်ပါသည်။
